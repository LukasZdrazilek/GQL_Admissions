...
class StudentExamLinkModel(BaseModel):
    ...
    student_id: Mapped[int] = mapped_column(ForeignKey("student_admissions.id"), index=True, default=None, nullable=True, comment="Foreign key referencing the student")
